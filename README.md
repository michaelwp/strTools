...
#### `STEP 1` :  Fork [this](https://github.com/michaelwp/strTools.git) repository.
#### `STEP 2` :  Clone your forked copy of the project.
```
git clone https://github.com/<your_username>/strTools.git
```
...
```
git remote add upstream https://github.com/michaelwp/strTools.git
```
